...
<body>
    <div class="container">
        ...
        <form action="authcode.php" method="POST"> 
            <div class="card shadow-md border border-gray-300 border-light max-w-sm m-auto w-100 rounded-md h-[20rem]">
             ...
             <button name="reset_password_btn" type="submit"  class="w-80 mx-8 text-1xl my-6 h-7 rounded-md" style="background-color: #FFD814;">Save changes and Sign In</button>
